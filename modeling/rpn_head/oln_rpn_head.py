...
from modeling.utils.util import normal_init, anchor_inside_flags, images_to_levels, unmap, multi_apply, bbox_overlaps
...
class OlnRPNHead(nn.Module):
    ...
    def __init__(self,
                 in_channels=256, feat_channels=256, num_classes=1,
                 ...
                 assigner=None,
                 sampler=None,
                 objectness_assigner=None,
                 objectness_sampler=None,

                 loss_cls=None,
                 loss_bbox=None,
                 loss_objectness=None,
                 nms_across_levels=None,
                 nms_pre=2000,
                 nms_post=2000,
                 max_num=2000,
                 nms_thr=0.7,
        ...
        self.objectness_assigner = objectness_assigner
        self.objectness_sampler = objectness_sampler
        ...
        self.nms_across_levels = nms_across_levels
    ...
    def forward_train(self,
        ...
        if gt_labels is None:
            loss_inputs = outs + (gt_bboxes, None, img_metas, gt_bboxes_ignore)
        else:
    ...
    def loss(self,
             ...
             img_metas,
             gt_bboxes_ignore=None):  # gt_labels is not used since we sample the GTs.
    ...
    def simple_test_rpn(self, x, img_metas, proposal_cfg=None):
        ...
        """
        rpn_outs = self(x)
        proposal_list = self.get_bboxes(*rpn_outs, img_metas, cfg=proposal_cfg)
